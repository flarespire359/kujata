...
const extractKernelKernel2Bin = async (inputKernelDirectory, outputKernelDirectory) => {
  ...
  const kernelData = decompressBinGzip(kernelBinPath, 27)
  const kernel2Data = decompressKernel2(kernel2BinPath)
  const data = {}
